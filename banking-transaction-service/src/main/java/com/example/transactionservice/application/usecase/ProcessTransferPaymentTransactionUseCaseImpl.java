...
public class ProcessTransferPaymentTransactionUseCaseImpl implements ProcessTransferPaymentTransactionUseCase {
    ...
    public TransactionProcessingResult execute(ProcessTransferPaymentCommand command) {
