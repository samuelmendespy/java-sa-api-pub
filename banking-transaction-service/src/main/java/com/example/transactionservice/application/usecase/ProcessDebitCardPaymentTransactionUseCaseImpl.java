...
public class ProcessDebitCardPaymentTransactionUseCaseImpl implements ProcessDebitCardPaymentTransactionUseCase {
    ...
    public TransactionProcessingResult execute(ProcessDebitCardPaymentCommand command) {
        ...
        BankAuthorizationRequest bankRequest = BankAuthorizationRequest.builder()
                ...
                .paymentMethod(PayMethodType.DEBIT_CARD.name())
