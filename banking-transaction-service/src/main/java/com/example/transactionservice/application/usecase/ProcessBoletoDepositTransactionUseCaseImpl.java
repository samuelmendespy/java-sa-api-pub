...
public class ProcessBoletoDepositTransactionUseCaseImpl implements ProcessBoletoDepositTransactionUseCase {
    ...
    public TransactionProcessingResult execute(ProcessBoletoDepositCommand command) {
